<script lang="ts">
    ...
    $:if(currentPageIndex) carousel.goTo(currentPageIndex);
</script>

<div class="container">
    <div class="navigationButtons" style="">
        <div on:click={carousel.goToPrev} class="button prev" style="background-color: {buttonColor};">
            &#10094;
        </div>
        <div on:click={carousel.goToNext} class="button next" style="background-color: {buttonColor};">
            &#10095;
        </div>
    </div>
    <Carousel
